...
const Chatbot = () => {
    ...
    return (
        <div className="w-full max-w-md mx-auto mt-10 border rounded-xl shadow-lg flex flex-col h-[600px] bg-white overflow-hidden">
            <div className="bg-black text-white text-lg font-semibold py-3 px-4">
                Car Assistant
            </div>
